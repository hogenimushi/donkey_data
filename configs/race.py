...
# 
# #WEB CONTROL
WEB_CONTROL_PORT = 18887             # which port to listen on when making a web controller
...
#SIM_HOST = "zxw001.u-aizu.ac.jp"              # when racing on virtual-race-league use host "trainmydonkey.com"
SIM_HOST = "localhost"
